...
async function main() {
  ...
  console.log({
    balanceA: await contractTokenA.balanceOf(ownerAddr),
    balanceB: await contractTokenB.balanceOf(ownerAddr),
  });
  ...
  console.log({
    reserve: await swapContract.getReserve(),
  });
  ...
  console.log({
    "balanceA after swap": await contractTokenA.balanceOf(ownerAddr),
    "balanceB after swap": await contractTokenB.balanceOf(ownerAddr),
  });

  console.log({
    reserveAfterSwap: await swapContract.getReserve(),
  });
}
